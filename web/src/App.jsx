...
const DEMO_DATA = {
  ...
  momentum: {
    sp500: { consecutive_up: 3, ath: 5250.0, ath_distance_pct: -2.39, daily_change_pct: 0.89 },
    qqq: { consecutive_up: 4, ath: 495.0, ath_distance_pct: -2.53, daily_change_pct: 1.43 },
    schd: { consecutive_up: 2, ath: 84.5, ath_distance_pct: -2.60, daily_change_pct: 0.55 },
  },
  volume: {
    ...
    schd: { volume: 5800000, volume_avg_20d: 5200000, volume_ratio: 1.12, up_day_avg_vol: 5500000, down_day_avg_vol: 4900000 },
  },
  calendar: [
...
const DEMO_HISTORY = Object.fromEntries([
  ...
  ['nq_futures', genHistory(18200, 100)],
  ...
  return (
    <div style={{ paddingBottom: 70 }}>
      ...
      {tab === 'summary' && (
        <SummaryTable
          sections={[
            { icon: '🇺🇸', title: '미국 시장', keys: SUMMARY_KEYS },
      ...
      {tab === 'analysis' && (
        <>
          ...
          <div style={{ padding: '12px 16px 8px' }}>
            <SectionHeader icon="📈" title="모멘텀 · 거래량" subtitle="S&P500 / QQQ / SCHD" />
          </div>
          <MomentumPanel
            indicators={data.indicators}
